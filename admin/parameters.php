...
<form enctype="multipart/form-data" method="post" action="">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;Ticket trés ancien <i>(Tâches)</i>: <input name="lign_orange" type="" value="<?php echo $rparameters['lign_orange']; ?>" size="1" /> jours <img src="./images/question.png" alt="question" title="Détermine, la couleur orange des tickets dans les Tâches" /><br />
