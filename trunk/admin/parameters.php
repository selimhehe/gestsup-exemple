...
<form enctype="multipart/form-data" method="post" action="">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;Activer la fonction LDAP: <input type="checkbox" <?php if ($rparameters['ldap']==1) echo "checked"; ?> name="ldap" value="1"> <img src="./images/question.png" alt="question" title="Active la liaison entre GestSup et l'annuaire utlisateur de l'entreprise (Exemple: Active Directory pour Windows Server)" /><br />
