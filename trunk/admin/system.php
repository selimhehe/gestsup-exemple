...
if ($phpinfo[$vphp]['max_execution_time'][0]>="30") echo '&nbsp;&nbsp;&nbsp;&nbsp;<img src="./images/ok_min.png" style="border-style: none" alt="img" /> <b>Max_execution_time:</b> '.$phpinfo[$vphp]['max_execution_time'][0].'s<br />'; else echo '&nbsp;&nbsp;&nbsp;&nbsp;<img src="./images/critical_min.png" style="border-style: none" alt="img" /> <b>Max_execution_time: </b>'.$phpinfo[$vphp]['max_execution_time'][0].'s Il est préconisé d\'avoir une valeur supérieur ou égale à 30s .<br />';
