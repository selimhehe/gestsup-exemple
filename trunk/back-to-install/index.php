		...
		<div id="content">
			...
			if ($step=='2')
			{
							...
							<blockquote>
								...
								if ($phpinfo[$vphp]['memory_limit'][0]!="") echo '&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/ok_min.png" style="border-style: none" alt="img" /> <b>Mémoire Allouée:</b> '.$phpinfo[$vphp]['memory_limit'][0].'<br />'; else {echo '&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/critical_yellow.png" style="border-style: none" alt="img" /><br />';}
								...
								if ($phpinfo[$vphp]['upload_max_filesize'][0]!="2M") echo '&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/ok_min.png" style="border-style: none" alt="img" /> <b>Upload max:</b> '.$phpinfo[$vphp]['upload_max_filesize'][0].'<br />'; else {echo '&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/critical_yellow.png" style="border-style: none" alt="img" />  Il est préconisé d\'avoir une valeur supérieur ou égale à 10M, pour les pièces jointes (cf fichier php.ni).<br />'; }
							...
							<blockquote>
								...
								echo "<br />";
								if ($ldap=="1") echo '&nbsp;&nbsp;&nbsp;&nbsp; <img src="../images/ok_min.png" style="border-style: none" alt="img" /> <b>php_ldap:</b> Activée'; else echo '&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/critical_yellow.png" style="border-style: none" alt="img" /> <b>php_ldap</b> Désactivé, la synchronisation des utilisateurs et l\'authentification via LDAP ne seront pas disponible.';
								echo "<br />";
								if ($zip=="1") echo '&nbsp;&nbsp;&nbsp;&nbsp; <img src="../images/ok_min.png" style="border-style: none" alt="img" /> <b>php_zip:</b> Activée'; else echo '&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/critical_yellow.png" style="border-style: none" alt="img" /> <b>php_zip</b> Désactivé, les mises à jour automatique ne seront pas disponible.';
								echo '
							</blockquote>';
			...
			/////ETAPE 3			
						if ($step=='3')
						{
							...
							echo "<br /><br />";
							echo '
							L\'application à été installé vous pouvez y acceder via l\'url: <a href="http://127.0.0.1/gestsup">http://127.0.0.1/gestsup</a>. <br />
