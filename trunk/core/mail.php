...
$objet="$robject[mail_object] du ticket n°$_GET[id]: $globalrow[title]";
					...
					<tr bgcolor=\"$rparameters[mail_color_bg]\" >
					  <td>
						...
						<table  border=\"1\" bordercolor=\"0075A4\" cellspacing=\"0\" width=\800px\">
							...
							<tr>
								<td width=\"400px\"><font color=\"$rparameters[mail_color_text]\"><b>Demandeur:</b></b> $userrow[firstname] $userrow[lastname]</font></td>
								<td width=\"400px\"><font color=\"$rparameters[mail_color_text]\"><b>Technicien en charge:</b> $techrow[firstname] $techrow[lastname]</font></td>
							</tr>
							<tr>
							...
							<tr>
								<td width=\"400px\"><font color=\"$rparameters[mail_color_text]\"><b>Date de résolution estimé:</b></b> $date_hope</font></td>
								<td width=\"400px\"><font color=\"$rparameters[mail_color_text]\"><b>Date de résolution:</b> $date_res</font></td>
							</tr>
						</table>
						<br /><br /><br /><br />
						<hr />
						Pour toutes informations complémentaires sur votre demande, vous pouvez joindre $techrow[firstname] $techrow[lastname] au $techrow[phone].
						<hr />
					  </td>
					</tr>
				</table>
