...
<body>
	<div id="wrap">
		<div id="header">
				...
				if ($_SESSION['user_id'])
				{
					...
					echo '
						<div id="topmenu">
							...
							if ($rright['task']!=0) {echo'<li ';if (isset($_GET['page']) && ($_GET['page']=="dashboard" || $_GET['page']=="ticket" || $_GET['page']=="newticket" || $_GET['page']=="newticket_u")) {echo "class=\"active\"";}echo '><a href="./index.php?page=dashboard&amp;techid='; echo $_SESSION['user_id']; echo '&amp;state=1"><img style="border-style: none" alt="tache" src="./images/check.png" />  T�ches</a></li>';}
			...
			{
				//user bar queries 
				$reqnb = mysql_query("SELECT count(*) FROM `tincidents` WHERE $profile='$uid' and (state LIKE '1' OR state LIKE '2') AND disable='0'"); 
				...
				if ($rright['userbar']!=0)
				{
					...
					<div class="postbottom">
						<img  style="border-style: none" alt="img" src="./images/admin.png" /><font color="#FFFFFF"><b><a href="./index.php?page=admin&amp;subpage=user&amp;action=edit&amp;id='.$_SESSION['user_id'].'"> '.$reqfname['firstname'].' '.$reqfname['lastname'].'</a></b></font>&nbsp;&nbsp;
						...
						<img  style="border-style: none" alt="img" src="./images/ico_more.png" /><a href="./index.php?page=dashboard&amp;techid='.$_SESSION['user_id'].'&amp;state=1"> A trait�: <b>'.$nbatt[0].'</b></a>&nbsp;&nbsp;
