...
if($_POST['save']||$_POST['mail']||$_POST['quit']) 
{
	...
	if ($rparameters['mail_newticket']==1)
	{
		...
		//Mail parameters
		$from=$rparameters['mail_cc'];
		$to=$rparameters['mail_newticket_address'];
		$object="Un nouvel incident à été déclaré par $userrow[firstname] $userrow[lastname]: $_POST[title]";
		$message = "
		L'incident n°$number à été déclaré par l'utilisateur $userrow[firstname] $userrow[lastname].<br />
		<br />
		<u>Objet:</u><br />
		$_POST[title]<br />		
		<br />	
...
<div id="catalogue">
	<form name="thisform" enctype="multipart/form-data" method="post" action="" id="thisform">
		...
		<?php echo "$reqfname[firstname] $reqfname[lastname]  "; 
