...
<div id="catalogue">
	...
	<?php
		...
		<?php
			...
			if (($globalrow['time_hope']<$globalrow['time']) && $globalrow['state']!='3') echo "<img border=\"0\" title=\"La durée estimée est inférieur à la durée déja passé.\" src=\"./images/critical_min.png\" />";
